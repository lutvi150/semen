<div class="content-wrapper">
	...
	<section class="content">
		<div class="box box-primary box-solid">
			...
			<!-- /.box-header -->
			<div class="box-body">
				<form action="<?php echo base_url();?>admin/simpan_produk" enctype="multipart/form-data" method="post" class="form-horizontal ">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
								<input type="text" required name="nama" id="nama" class="form-control" placeholder="Nama Produk">
							</div>
							</div>
						   ...
						   <div class="form-group">
							<label class="col-sm-4 control-label">Detail Produk</label>
							 <div class="col-sm-8">
								<textarea name="detail" id="detail" class="form-control" cols="30" rows="10">Isi dengan detail products</textarea>
							 </div>
						</div>
							<div class="form-group">
							   <label class="col-sm-4 control-label">Satuan</label>
								<div class="col-sm-8">
								   <input type="text" required name="satuan" id="satuam" class="form-control"
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<img id="output" class="gambar" name="foto"
									src="<?=base_url();?>asset/img/no-image-found-360x260.png" alt="">
									</div>
							</div>
