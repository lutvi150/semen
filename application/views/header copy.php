...
<body>
        ...
        <div class="left-sidebar-pro">
            <nav id="sidebar" class="">
                ...
                <a href="index.html"><img class="main-logo" src="<?=base_url();?>asset/img/logo/logo.png" alt="" /></a>
                    <strong><a href="index.html"><img src="<?=base_url();?>asset/img/logo/logosn.png" alt="" /></a></strong>
                </div>
                                                ...
                                                <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                    ...
                                                    <li class="nav-item">
                                                        <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                                <img src="<?=base_url();?>asset/img/product/pro4.jpg" alt="" />
