		...
		?>
								...
								<td><?=$no++?></td>
									...
									<td><?php if ($field2['harga_satuan']=='-'):?>
										...
										<?php endif; ?></td>
									<td>
										<?php if ($field2['harga_satuan']=='-'):?>
										<span class="label label-danger">Menunggu Konfirmasi</span>
										<?php else: ?>
										<?php if ($field2['status_request']):?>
									...
									<?php if ($field2['harga_satuan']=='-'):?>
										<span class="label label-danger">Menunggu Konfirmasi</span>
									<?php else: ?>
									<?php if ($field2['status_request']!=="S"):?>
									
										<a href="#" class="btn btn-success btn-sm setuju-transaksi" data="<?=base_url();?>pelanggan/setuju_request/<?=$field2['id_uniq_request']?>"><i class="fa fa-check"></i> Setuju</a>
									<?php endif; ?>
									<?php endif; ?>
									</td>
...
<!-- Modal -->
<div class="modal fade" id="setuju_transaksi" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content">
			<form action="" id="form_setuju_transaksi" method="post">
			<div class="modal-header">
